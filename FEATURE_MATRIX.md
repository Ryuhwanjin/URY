...
| v0.9.7 플랫폼별 업데이트 수정 | 완료 | 현재 플랫폼 DMG 또는 Windows EXE/ZIP만 비교하는 업데이트 검사기와 Markdown·PDF 설명서 포함 반영. macOS·Windows 빌드 및 GitHub Release 4개 asset 업로드 완료. 기존 버전 업데이트 설치 실기기 검증 대기 |
