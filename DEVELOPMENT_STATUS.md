...
- 플랫폼별 업데이트 인식 수정의 v0.9.7 배포 빌드:
  ...
  - 현재 상태: v0.9.7 버전 표기 갱신, macOS 앱·DMG·ZIP 빌드 완료. Windows 설치 번들에 설명서 포함 보강과 Actions 재빌드 전
  - 바로 다음 명령: 설명서 포함 패치를 커밋·push하고 Windows Actions의 EXE·설치파일 artifact 및 설명서 포함 여부 확인
