...
- 저장소 구조 정리 완료: 미참조 아이콘·보안 우회 스크립트·수동 전체 파이프라인 런처와 dead wrapper를 제거하고, macOS launcher의 자동 quarantine 해제를 없앴다. README·DMG/릴리즈 빌드 안내를 갱신했으며 전체 테스트 44개 통과(1개 환경 의존 제외), 커밋 `363d072`
