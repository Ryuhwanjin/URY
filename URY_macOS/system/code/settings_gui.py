...
class UnifiedDashboardApp:
    def __init__(self, root):
        self.root = root
        self.root.title("URY — Academic Studio v0.9.7")
...
URY는 사용자의 로컬 컴퓨터 내에서만 독립적으로 동작하며, 어떠한 강의 음성이나 자료도 중앙 서버에 수집·보관하지 않습니다. AI 결과물은 학업 보조용 조교일 뿐 최종 시험 평가 기준을 대체하지 않습니다."""
    ...
    def create_header_card(self):
        ...
        tk.Label(title_row, text=" v0.9.7", font=("Pretendard", 9), bg="#ffffff", fg="#64748b").pack(side=tk.LEFT)
    ...
    def build_update_tab(self):
        ...
        card.pack(fill=tk.X)
        ttk.Label(card, text="현재 버전  v0.9.7", font=("Pretendard", 15, "bold"),
